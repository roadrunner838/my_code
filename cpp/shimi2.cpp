...
int main() {
    map<string, double> atomicMasses = {
        ...
        {"Dy", 162.5}, {"Ho", 164.93}, {"Er", 167.26}, {"Tm", 168.93}, {"Yb", 173.04},
   ...
   int flag ;
   while (exit){
    cout << "Enter the symbol of the element And if you want to leave, hit q : ";
    cin >> element;

         if (atomicMasses.find(element) != atomicMasses.end()) {
            cout <<"Enter the number of atoms ";
            cin >> num ;
            num*= atomicMasses[element];
       ...
       sum+= num ;
        ...
        cout << "Element not found!" << endl;
                 ...
                 cout << "If you want to enter the number 1, if not, enter 0 :";
                 cin >> flag ;
                 if (flag==1 ){
                    exit=true;
                 }
